...
class Organism {
 ...
 public:
  ...
  virtual bool considerAction();
  virtual bool abilityActive();
  virtual int getCooldownReps();
  virtual int getStrengthDecreaseReps();
  bool getLifeStatus();
  ...
  int findFreeRecreationSpot(Organism* partner) const;
